...
class PurchaseReceiptItem:
    def __init__(self, item_code, qty, expense_account, warehouse):
...
def post_purchase_receipts(docname):
    try:
        ...
        if purchase_receipt.custom_voucher_no:
        ...
        server = [
            "http://102.22.220.246/api/resource",
        ...
        if posted_receipt:
            frappe.db.set_value("Purchase Receipt", docname, "custom_voucher_no", posted_receipt)
